  ...
  return (
    <section className="min-h-screen bg-gradient-bg flex flex-col items-center justify-center px-4 py-12 text-center">
      <div className="max-w-6xl mx-auto space-y-8">
        {/* Header Banner */}
        <div className="bg-gradient-accent text-white p-3 sm:p-4 rounded-xl sm:rounded-2xl shadow-card transform hover:scale-105 transition-smooth mx-2">
        ...
        <div className="space-y-4 sm:space-y-6 px-2">
          <h1 className="text-2xl sm:text-3xl md:text-6xl lg:text-7xl font-black leading-tight">
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-4xl mx-auto font-medium">
